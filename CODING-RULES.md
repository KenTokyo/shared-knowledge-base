...
- **Browser-Playwright mit Microsoft Edge (PFLICHT):** Normale Browser-Playwright-CLI-Tests in NoteDrill bevorzugt mit Microsoft Edge/System-Edge ausführen, nicht mit Chrome, weil Edge lokal performanter ist und Chrome in NoteDrill-Smokes stärker laggt. Ausnahme nur, wenn Edge fehlt oder ein Feature ausdrücklich Chrome verlangt. Electron-Playwright-CLI bleibt davon unberührt und nutzt weiter den Electron-/Chromium-Projektwrapper.
