...
-- Submodule z.B. shared-docs auch commiten, immer am Ende der Tasks, bitte beachten
...
- **UI zuerst an professioneller Referenz ausrichten (User 2026-09-05):** Vor Layout-/Komponentenänderungen eine passende bestehende Anwendung prüfen, bevorzugt Linear, Codex oder Synara. In der Task-Datei Quelle/Stand und konkrete übertragene Merkmale nennen: Hierarchie, Spacing-Raster, Innenabstände, Button-/Zeilenhöhen, Typografie, Zustände und Verhalten bei schmaler Breite. Screenshot oder tatsächlichen Quellcode prüfen; Produktnamen allein sind keine Referenz. Bestehende Design-Komponenten und Theme-Tokens nutzen, Hell/Dunkel sowie angebotene Farbthemes berücksichtigen. Wiederholte Karten, uneinheitliche Größen und dekorative Extras nicht als Verbesserung liefern. Erlaubte Abnahme mit denselben Zuständen/Breiten gegen die Referenz vergleichen; ungesehene Optik nicht als geprüft ausgeben. Selbstständig ausführen, kein zusätzlicher Freigabestopp.
