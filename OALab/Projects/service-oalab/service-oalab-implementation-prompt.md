...
Noch eine wichtige Sache. Ich werde dir auf jeden Fall so einen Ordner bereitstellen mit accounts.md. Ich glaube, ich mache das jetzt schon. accounts.md. Also alles, was du zum Thema wissen musst, wie man auf was zugreift. Das ist ja eigentlich, das gehört auch dazu, dieses Vercel CLI Workflow sich anzuschauen. Vielleicht hilft dir das, obwohl ich weiß nicht, ob dir das wirklich hilft. Nee, das hilft nicht. Du brauchst ja Netcup. Wir brauchen so eine Netcup-Datei, eventuell. Auch vielleicht, ja. Du musst ja irgendwie Computer use brauchst du auf jeden Fall. Du hast ja Computer use Zugang zu Computer use. Ich hoffe, das ist alles integriert. Netcup, guck mal, du brauchst auch vielleicht Zugang zum Browser. Du kannst dich mit Browser quasi anmelden natürlich im Netcup. Wie mache ich das meistens? Also, ich mache das so, ich gehe auf netcup.de und dann logge ich mich ein. Und dann müsstest du, genau. Ich glaube über Discord, ich gehe mal Discord rein. Weil da habe ich die Daten. Ich mache das alles in die ENV rein. Und dann kriegen wir meistens eine TAN in unseren E-Mail-Postfach. Und du kannst eigentlich, müsstest, ja. Oder wir machen die Domain-Einstellung. Pass auf, ich mache die Domain-Einstellung, du kümmerst dich nur. Du kannst aber, ja, schau, was du brauchst. Und das schreibe ich alles in die ENV rein. Aber du machst ja schon mal den Rest schon mal selbst, kannst du schon mal aufbauen. Genau. Ich werde das dann mit, ich kann das natürlich, genau. Ich kann das mit Qlify verbinden, Vercel, egal was. Qlify haben wir auch. Besser ist alles selbst hosted. Supabase müssen wir nicht selbst hosten. Sag mir nur, was ich in der Datei auszufüllen habe am Ende, wenn alles fertig ist. Genau. Aber schon mal alles vorher implementieren. Und dann, wenn du was brauchst, alles, was für Daten du brauchst, Zugangsdaten, kann ich dir alles dann geben. Zu E-Mail-Konten, wie auch immer, was auch immer du brauchst. Genau.