...
| **Shardfall Flakes** (`Claude-Flakes/shardfall-flakes`) | `D:\CODING\React Projects\github-repos-examples\Claude-Flakes\shardfall-flakes` | Shardfall Arena v2.5 als Kopie mit der Elemental-Flakes-Zauberbibliothek darin. Kein Shooter, kein Bausystem. Start `npm run arena`, Prüflauf `npm run arena:gate` (20 Schritte). | Three.js · WebGL2 · GLSL · React | TypeScript / JavaScript | [5179](http://localhost:5179) fest / [4179](http://localhost:4179) fest |
