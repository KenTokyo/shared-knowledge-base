...
For Example, if you would create an boxer, you would do this:
...
Depending on what you build or what you have to adjust oder was du anpassen sollst, muss du natürlich andere arten von VFX bauen, aber in dieser Richtung soll es gehen

Beispiel vfx projekte an denen du dich orientieren kannst:
D:\CODING\React Projects\github-repos-examples\LinearAbiltyCastingThreeJS
```
