...
## Leitfrage
Was bedeutet Kontext bei LLMs genau, und warum ist er für NoteDrill eine Kernfunktion?

## Kurzantwort in einfacher Sprache
- Arbeitsgedächtnis ist ein Kernbegriff, weil er die reale Last im Modellfenster beeinflusst.
- Priorisierung muss sauber getrennt werden, damit Werte zwischen Providern vergleichbar bleiben.
- Reservetoken ist hilfreich, darf aber nie still als exakter Wahrheitswert dargestellt werden.
- Handoff sollte als Risikoindikator im UI sichtbar sein, sobald das Budget knapp wird.
- Drift braucht eine einheitliche Benennung in Code, Doku und Telemetrie.
- Warnstufen entscheidet, ob Auto-Condense stabil auslöst oder zu spät reagiert.
...
- Die Themen 'Kontext-Grundlagen' und 'Arbeitsgedächtnis' sind direkt mit den bestehenden Codepfaden verknüpft.
- Alle Entscheidungen sollen mit messbaren Abnahmekriterien hinterlegt werden.

## Konkrete Übertragung auf NoteDrill
- CTX-Status klar darstellen.
- Handoff-Pflichtfelder erzwingen.
- Modellabhängige Schwellen nutzen.
...
- Das Thema 'Kontext-Grundlagen' profitiert in NoteDrill von derselben Trennung zwischen Datenvertrag und UI.
...
1. Datenvertrag für 'Kontext-Grundlagen' mit Versionsfeld finalisieren.
...
## Kurzfazit
- Das Themenblatt 'Kontext-Grundlagen' verbindet Quellenlage, Codebezug und konkrete Umsetzung.
