...
## Leitfrage
Was ist ein Token praktisch, und welche typischen Fehler passieren beim Zählen?

## Kurzantwort in einfacher Sprache
- Tokeneinheit ist ein Kernbegriff, weil er die reale Last im Modellfenster beeinflusst.
- InputOutput muss sauber getrennt werden, damit Werte zwischen Providern vergleichbar bleiben.
- CacheAnteil ist hilfreich, darf aber nie still als exakter Wahrheitswert dargestellt werden.
- Schätzwert sollte als Risikoindikator im UI sichtbar sein, sobald das Budget knapp wird.
- ProviderUsage braucht eine einheitliche Benennung in Code, Doku und Telemetrie.
- Kostenbezug entscheidet, ob Auto-Condense stabil auslöst oder zu spät reagiert.
...
- Die Themen 'Token-Grundlagen' und 'Tokeneinheit' sind direkt mit den bestehenden Codepfaden verknüpft.
- Alle Entscheidungen sollen mit messbaren Abnahmekriterien hinterlegt werden.

## Konkrete Übertragung auf NoteDrill
- Genauigkeitslabel überall zeigen.
- Source-Feld in Logs durchreichen.
- Preflight-Hinweis vor großen Prompts.
...
- Das Thema 'Token-Grundlagen' profitiert in NoteDrill von derselben Trennung zwischen Datenvertrag und UI.
...
1. Datenvertrag für 'Token-Grundlagen' mit Versionsfeld finalisieren.
...
## Kurzfazit
- Das Themenblatt 'Token-Grundlagen' verbindet Quellenlage, Codebezug und konkrete Umsetzung.
