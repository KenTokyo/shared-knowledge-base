...
## Leitfrage
Welche Felder muss ein Übergabemodell enthalten, damit die nächste KI sofort verlässlich weiterarbeiten kann?

## Kurzantwort in einfacher Sprache
- Pflichtfelder ist ein Kernbegriff, weil er die reale Last im Modellfenster beeinflusst.
- SchemaVersion muss sauber getrennt werden, damit Werte zwischen Providern vergleichbar bleiben.
- Dateireferenzen ist hilfreich, darf aber nie still als exakter Wahrheitswert dargestellt werden.
- OpenTodos sollte als Risikoindikator im UI sichtbar sein, sobald das Budget knapp wird.
- Phase braucht eine einheitliche Benennung in Code, Doku und Telemetrie.
- Validierung entscheidet, ob Auto-Condense stabil auslöst oder zu spät reagiert.
...
- Die Themen 'Handoff-Datenmodell' und 'Pflichtfelder' sind direkt mit den bestehenden Codepfaden verknüpft.
- Alle Entscheidungen sollen mit messbaren Abnahmekriterien hinterlegt werden.

## Konkrete Übertragung auf NoteDrill
- Schema versionieren.
- Top-3-Dateien pro Phase speichern.
- Write-Validierung hart machen.
...
- Das Thema 'Handoff-Datenmodell' profitiert in NoteDrill von derselben Trennung zwischen Datenvertrag und UI.
...
1. Datenvertrag für 'Handoff-Datenmodell' mit Versionsfeld finalisieren.
...
## Kurzfazit
- Das Themenblatt 'Handoff-Datenmodell' verbindet Quellenlage, Codebezug und konkrete Umsetzung.
