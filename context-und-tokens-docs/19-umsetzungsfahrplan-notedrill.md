...
## Leitfrage
Wie setzen wir die Erkenntnisse in einen realistischen, phasenweisen Fahrplan für NoteDrill um?

## Kurzantwort in einfacher Sprache
- Phasenplan ist ein Kernbegriff, weil er die reale Last im Modellfenster beeinflusst.
- Risikoabbau muss sauber getrennt werden, damit Werte zwischen Providern vergleichbar bleiben.
- FeatureFlag ist hilfreich, darf aber nie still als exakter Wahrheitswert dargestellt werden.
- Canary sollte als Risikoindikator im UI sichtbar sein, sobald das Budget knapp wird.
- Rollout braucht eine einheitliche Benennung in Code, Doku und Telemetrie.
- SupportReadiness entscheidet, ob Auto-Condense stabil auslöst oder zu spät reagiert.
...
- Die Themen 'Umsetzungsfahrplan NoteDrill' und 'Phasenplan' sind direkt mit den bestehenden Codepfaden verknüpft.
- Alle Entscheidungen sollen mit messbaren Abnahmekriterien hinterlegt werden.

## Konkrete Übertragung auf NoteDrill
- Roadmap in Phasen fixieren.
- Canary-Messpunkte definieren.
- Cleanup-Loop verpflichtend machen.
...
- Das Thema 'Umsetzungsfahrplan NoteDrill' profitiert in NoteDrill von derselben Trennung zwischen Datenvertrag und UI.
...
1. Datenvertrag für 'Umsetzungsfahrplan NoteDrill' mit Versionsfeld finalisieren.
...
## Kurzfazit
- Das Themenblatt 'Umsetzungsfahrplan NoteDrill' verbindet Quellenlage, Codebezug und konkrete Umsetzung.
