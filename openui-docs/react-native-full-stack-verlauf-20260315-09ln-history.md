# Chat History: react native full stack verlauf 20260315 09ln

*Created on 3/15/2026, 3:30:18 AM*
...
Request and render flow [#request-and-render-flow]
...
chat-app/library.tsx - React Native renderers [#chat-applibrarytsx---react-native-renderers]
...
chat-app/hooks/useStreamingChat.ts - progressive streaming via XHR [#chat-apphooksusestreamingchatts---progressive-streaming-via-xhr]
...
chat-app/components/BotBubble.tsx - rendering the in-progress response [#chat-appcomponentsbotbubbletsx---rendering-the-in-progress-response]
...
backend/src/library.ts - Node-compatible prompt source [#backendsrclibraryts---node-compatible-prompt-source]
...
backend/src/app/api/chat/route.ts - raw text streaming endpoint [#backendsrcappapichatroutets---raw-text-streaming-endpoint]
