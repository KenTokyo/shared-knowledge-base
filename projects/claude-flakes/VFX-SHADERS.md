...
- **Faktor auf den Radius kann Glätte nicht ändern** — Körper wirkt glatt, also wird die Modulation erhöht oder der Körper verbreitert, und der Bericht bleibt Wort für Wort gleich; die Modulation ist ein *Anteil* des Radius, also skaliert der Wackler exakt mit und das Verhältnis, das das Auge liest, steht still. → Umrisswanderung als **Anteil der gezeichneten Größe** messen, nicht in Metern; Form über den Querschnitt brechen (`flatten`, Aspekt ≠ 1), denn ein Rotationskörper bleibt bei jedem Radius ein Rohr.
  *Tidecall: `girth` 0,62→0,90 lässt 37,5 % Umrissanteil auf die Nachkommastelle stehen, Querschnitt-Ellipse hebt auf 57,1 %; drei Anläufe davor waren Multiplikationen auf denselben Kreis · 2026-08-05*
