...
**Lesen wenn:** du eine Kennzahl definierst, eine Schwelle setzt, ein Tor formulierst oder einen
Sweep rankst.
**Status:** freiwillige Tipps · gemessen bessere Lösung → Vorrang · Änderungsrecht siehe [LEARNING-SYSTEM.md](../../LEARNING-SYSTEM.md)

Abgespalten von [`HARNESS-GATES.md`](HARNESS-GATES.md), das mit 24 Tipps das Doppelte der in
[LEARNING-SYSTEM.md](../../LEARNING-SYSTEM.md) genannten Obergrenze trug — geteilt nach Trigger, wie
dort verlangt: dort steht, wie man **misst**, hier, was eine Zahl **behaupten** darf. Kein Tipp wurde
dabei geändert; die Belege stehen unverändert.

Fast jeder Tipp hier stammt aus `tools/grade.mjs` und `tools/capture.mjs`. Deren Dateiköpfe tragen
die ausführliche Fassung mitsamt Nachrechnung — hier steht der übertragbare Teil.
