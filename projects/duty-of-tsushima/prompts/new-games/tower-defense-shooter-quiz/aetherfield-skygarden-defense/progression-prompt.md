# Aetherfield: Skygarden Defense — Progression Build Prompt
...
```text
CREATE AETHERFIELD: SKYGARDEN DEFENSE — COMPLETE PROGRESSION, ECONOMY, AND RECORDS
...
Make a broad empty voxel farm visibly and mechanically grow into a personalized defense network without losing its crops or field layout.
...
- Farm growth, chunky weapon parts, broad tower modules, and skill effects visibly reflect purchased choices from the high camera.
...
- Preserve Skygarden's 60–65-degree bird's-eye camera and 4–6% hero-height target at every progression tier.
- Keep crop plots, orchard rows, irrigation, lanes, barns, and open build ground as the map's largest shapes.
- Every structure tier adds one or two broad readable masses instead of layers of tiny realistic fittings.
- Fence growth remains chunky timber → pale-stone brace → wind-aether latch and never becomes a military wall.
- Weapon growth changes the held voxel silhouette through barrel, stock, canister, or emitter shape, not rarity glow alone.
- Hero unlocks add blocky packs, plates, cloth shapes, or tools without realistic anatomy or portrait detail.
- Wave-30 density must still reveal the original farm plan, productive crops, and every legal route.
- Meta unlocks never replace the working farm with a palace, ornamental fantasy city, or photoreal stronghold.

PRODUCT TRUTH

- One complete map at launch: Skygarden Expanse.
