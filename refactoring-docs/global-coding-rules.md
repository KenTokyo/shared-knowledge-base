...
*   **5.32 Limit-Awareness bei Listen:** Wenn Server-Finder ein `limit` nutzt, muss die UI das Limit klar anzeigen (z. B. „100 Ergebnisse (Limit)“) oder `totalCount/hasMore` liefern. Niemals „Alle geladen“, wenn die Daten gedeckelt sind.
