...
7. Browser-based runtime visual/gameplay/performance review only with current explicit permission from the **Fachregeln und Sichtprüfung** section in `CODING-RULES.md`; reading supplied local reference images is not gated.
